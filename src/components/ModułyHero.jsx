    ...
    <div className='max-w-[1390px] px-3 mx-auto pt-[110px]'>
      <div className='max-w-[1366px] rounded-[30px]  px-4 pt-[77px] bglightpurple pb-[33px]  mb-[63px] relative'>
        ...
        <div className='flex justify-center mb-[18px]'>
          <div className='border border-[#5E13F6] rounded-[30px] font-bold sm:text-[16px] text-[14px] whitespace-nowrap bg-[#E4D7FF] text-[#5E13F6] py-[11px] px-[16px]'>Inteligentna. Niezawodna. Wytrwała.</div>
        </div>
        <Heading className='mb-[39px]'>7 modułów do pełnej obsługi</Heading>
        <img src={circles} alt="img" className='mx-auto sm:block hidden' />
      </div>
    </div>
  )
}
