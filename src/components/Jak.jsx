...
//       <div className='max-w-[1140px] rounded-2xl shadowblack py-[62px] px-[60px] border-[2px]  border-[#F6F5F4]  h- [620px]'>
...
//           <div className="md:w-1/2 w-[90%] md:pr-[105px] relative left-0 max-md:left-[5%] mb-10">
//             <SubHeading
...
//               <img src={timeline1} alt="img" className='absolute top-[60%] -right-[90%] -z-1 ' />
//               <Jaksvg1  />
//             </div>
//           </div>

//           <div
//             className="md:w-1/2 w-[90%] md:pl-[113px] relative left-[50%] max-md:left-[5%] mb-5">
//             <SubHeading
...
//               <img src={timeline2} alt="img" className='absolute top-[60%] -left-[92%] -z-1 ' />
...
//         <div className="md:w-1/2 w-[90%] md:pr-[105px] relative left-0 max-md:left-[5%]">
//           <div className="">
//             <SubHeading
//               className="!text-[20px] text-[#000302] md:text-right mb-[6px] ">
