...
const Ciebiezrobic = () => {
  return (
    <div className='max-w-[1164px] mx-auto px-3 lg:mb-[164px] mb-[120px] '>
      <div className='max-w-[1140px] bglightpurple rounded-2xl sm:px-[26px] px-[17px] sm:py-[58px] py-[48px] border-[2px] border-[#F6F5F4] shadow-cie '>
        ...
        <div className='grid sm:grid-cols-2 grid-cols-1 gap-x-[31px] gap-y-[40px] '>
          {Ciebie_Data.map((item, index) => (
            <div className='flex items-center flex-col sm:bg-white rounded-[15px] md:p-[22px] sm:p-4 hover:shadow-cie cursor-pointer transition-shadow duration-150 ' key={index}>
              <div
